...
import {
  ...
  PlatformWindowToken,
} from '@nx-little-manufacturer/core';
...
export class NxLittleManufacturerCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: NxLittleManufacturerCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'NxLittleManufacturerCoreModule');
  }
}
